      ...
      <div className="mb-3 flex w-full">
        ...
        <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4">
          ...
          <div className="flex items-center gap-1">
            ...
            {/* <button
              className="flex h-6 w-6 items-center justify-center rounded bg-gray-200"
  ...
  return (
    ...
    >
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`https://pm-llc-s3-images.s3.ap-southeast-2.amazonaws.com/${task.attachments[0].fileURL}`}
          ...
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https://pm-llc-s3-images.s3.ap-southeast-2.amazonaws.com/${task.assignee.profilePictureUrl!}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://pm-llc-s3-images.s3.ap-southeast-2.amazonaws.com/${task.author.profilePictureUrl!}`}
